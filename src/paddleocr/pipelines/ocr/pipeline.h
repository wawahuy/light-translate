...
#include "src/paddleocr/common/parallel.h"
#include "src/paddleocr/common/image_batch_sampler.h"
...
#include "src/paddleocr/utils/ilogger.h"
...
public:
  ...
  std::vector<std::unique_ptr<BaseCVResult>>
  Predict(const std::vector<cv::Mat> &images);
